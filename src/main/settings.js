...
const DEFAULT_SETTINGS = { resolution: { width: 1440, height: 800 }, muted: false, switchOnTurn: true, notifications: true, autoAcceptOwn: true, noConfirm: true, showResources: false, keybinds: {} };

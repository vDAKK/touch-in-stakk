...
const FR = {
  ...
  'donation.sub': 'Chaque soutien aide STAKK à continuer.',
  'donation.message': 'Si le launcher te plaît, tu peux aider son développement en faisant un don sur Ko-fi.',
  'donation.dismiss': 'Ne plus afficher',
  'donation.close': 'Plus tard',
  'donation.support': 'Soutenir sur Ko-fi',
...
const EN = {
  ...
  'donation.sub': 'Every contribution helps STAKK continue.',
  'donation.message': 'If you enjoy the launcher, you can help its development with a donation on Ko-fi.',
  'donation.dismiss': 'Do not show again',
  'donation.close': 'Later',
  'donation.support': 'Support on Ko-fi',
